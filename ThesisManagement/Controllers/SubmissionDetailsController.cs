...
namespace ThesisManagement.Controllers
{
    ...
    public class SubmissionDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SubmissionId,ProjectId,SubmissionDesc,SubmissionDueOn,SubmissionOn,SubmissionFile,FileContentType,ReviewedBy,ReviewOn,Remarks")] SubmissionDetail submissionDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SubmissionId,ProjectId,SubmissionDesc,SubmissionDueOn,SubmissionOn,SubmissionFile,FileContentType,ReviewedBy,ReviewOn,Remarks")] SubmissionDetail submissionDetail)
        {
